...
urlpatterns = [ 
    ...
    path('export_filter/',export_filter,name='export_filter'),
    path('export_general_report_csv/',export_general_report_csv,name='export_general_report_csv'),
    path('export_report_csv_last_7_days/',export_report_csv_last_7_days,name='export_report_csv_last_7_days'),
    path('export_report_csv_today/',export_report_csv_today,name='export_report_csv_today'),
    path('Vaccination/',Vaccination,name='Vaccination'),
    path('user/',user,name='user'),
    path('HCuser/',HCuser,name='HCuser'),
    path('operator/',operator,name='operator'),
    path('resetPassword/',resetPassword,name='resetPassword'),
    path('HCmember/',HCmember,name='HCmember'),
    ...
    path('allvaccined/',allVaccined.as_view()),
    path('AllVax/<int:user_id>/',VaxlistbyID.as_view()),
